...
tooltips.set('edit-mode-off', { tooltip: 'Currently not editing', color: null })
tooltips.set('edit-mode-on', { tooltip: 'In editing mode', color: null })
...
tooltips.set('login', { tooltip: 'Login', color: null })
tooltips.set('logout', { tooltip: 'Logout', color: null })
